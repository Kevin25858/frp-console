                ...
                <div className="flex-1 overflow-hidden flex flex-col">
                    {loading ? (
                        ...
                        <textarea
                            ...
                            readOnly={readOnly}
                            className="flex-1 w-full min-h-[400px] p-4 bg-muted border rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-primary config-editor-textarea"
                            placeholder="# 配置文件内容"
                            spellCheck={false}
                            autoCapitalize="off"
                            autoCorrect="off"
