...
from tasks.update_check import update_check_task
...
from api.routes.updates import updates_bp
...
def create_app(testing=False):
    ...
    app_instance.register_blueprint(config_bp)
    app_instance.register_blueprint(updates_bp)
...
socketio = SocketIO(app, cors_allowed_origins=allowed_origins if allowed_origins else None, async_mode='threading')
